...
## 1. لاگ ارسال پیامک‌ها ✅ پیاده‌سازی‌شده در v2.1.0
...
## 13. یادداشت خودکار در سفارش ✅ پیاده‌سازی‌شده در v2.2.0
...
- یک `Makefile` با دستورات `make up`, `make test`, `make shell`

---

## اولویت‌بندی پیشنهادی

| اولویت | آیتم | تأثیر | پیچیدگی |
|--------|------|-------|---------|
| ۱ | لغو پیامک هنگام لغو سفارش (#3) | بالا | کم |
| ۲ | پاکسازی هنگام حذف (#16) | بالا | کم |
| ۳ | فرمت‌بندی شماره تلفن (#5) | بالا | کم |
| ~~۴~~ | ~~یادداشت خودکار در سفارش (#13)~~ | ~~متوسط~~ | ~~کم~~ | ✅ v2.2.0 |
| ۵ | سازگاری HPOS (#14) | بالا | کم |
| ~~۶~~ | ~~لاگ ارسال (#1)~~ | ~~بالا~~ | ~~متوسط~~ | ✅ v2.1.0 |
| ۷ | Meta Box در صفحه سفارش (#8) | متوسط | متوسط |
| ۸ | بررسی موجودی پنل (#9) | متوسط | متوسط |
| ۹ | Retry ارسال ناموفق (#2) | بالا | متوسط |
| ۱۰ | جایگزینی با Action Scheduler (#4) | بالا | متوسط |
| ۱۱ | Opt-Out مشتریان (#10) | متوسط | متوسط |
| ۱۲ | پشتیبان‌گیری تنظیمات (#15) | کم | کم |
| ۱۳ | بررسی موجودی پنل - هشدار (#9) | متوسط | متوسط |
| ۱۴ | داشبورد آمار (#17) | متوسط | زیاد |
| ۱۵ | قوانین شرطی (#6) | زیاد | زیاد |
| ۱۶ | ارسال انبوه (#12) | متوسط | زیاد |
| ۱۷ | اطلاع‌رسانی به ادمین (#7) | متوسط | کم |
| ۱۸ | REST API خارجی (#18) | کم | متوسط |
| ۱۹ | WP-CLI (#19) | کم | متوسط |
| ۲۰ | چند ارائه‌دهنده SMS (#11) | متوسط | زیاد |
| ۲۱ | تست‌های خودکار (#21) | بالا | متوسط |
| ۲۲ | Docker dev environment (#22) | کم | متوسط |
| ۲۳ | بین‌المللی‌سازی (#20) | کم | زیاد |

---

## نقشه راه پیشنهادی (Roadmap)

### نسخه ۲.۲ — پایداری (جزئی پیاده‌سازی‌شده)
- لغو پیامک هنگام لغو سفارش (#3)
- فرمت‌بندی خودکار شماره تلفن (#5)
- ~~یادداشت خودکار در سفارش (#13)~~ ✅ v2.2.0
- سازگاری HPOS (#14)
- پاکسازی هنگام حذف (#16)

### نسخه ۲.۳ — قابلیت مشاهده
- ~~لاگ ارسال با جدول دیتابیس (#1)~~ ✅ v2.1.0
- Meta Box در صفحه سفارش (#8)
- بررسی و هشدار موجودی (#9)

### نسخه ۲.۴ — قابلیت اطمینان
- مکانیزم Retry (#2)
- جایگزینی با Action Scheduler (#4)
- Opt-Out مشتریان (#10)

### نسخه ۳.۰ — پلتفرم
- قوانین شرطی پیشرفته (#6)
- ارسال انبوه (#12)
- چند ارائه‌دهنده SMS (#11)
- داشبورد آمار (#17)
