...
6. [قوانین شرطی پیشرفته](#6-قوانین-شرطی-پیشرفته) ⚗️ پیاده‌سازی جزئی
...
> ⚗️ پیاده‌سازی جزئی در v2.33.0 — فیلتر `product_id` به صورت بلک لیست/وایت لیست برای هر قانون پیاده‌سازی شد. بقیه انواع شرط‌ها (مبلغ، روش پرداخت، دسته‌بندی و...) هنوز پیاده‌سازی نشده‌اند.
